...
@Table(
        name = "t_custom_app_record_values",
        indexes = {
                @Index(name = "idx_custom_app_record_values_record", columnList = "record_id"),
                @Index(name = "idx_custom_app_record_values_property", columnList = "property_id")
        }
)
@EntityListeners(AuditingEntityListener.class)
public class CustomAppRecordValue extends GeneratedIdAuditEntity {
