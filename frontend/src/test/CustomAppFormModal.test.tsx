...
import { CustomAppFormModal } from '../features/custom-apps/components/CustomAppFormModal';
import type { CustomApp } from '../features/custom-apps/types';
...
function renderModal(customApp?: CustomApp) {
  const client = new QueryClient({ defaultOptions: { queries: { retry: false } } });
  return render(
    <QueryClientProvider client={client}>
      <CustomAppFormModal customApp={customApp} onClose={vi.fn()} />
    </QueryClientProvider>,
  );
}

describe('CustomAppFormModal icon picker', () => {
  beforeEach(() => {
