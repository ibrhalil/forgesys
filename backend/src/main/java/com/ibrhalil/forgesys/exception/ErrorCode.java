...
public enum ErrorCode {
    ...
    CUSTOM_APP_NAME_TAKEN(HttpStatus.BAD_REQUEST, "Custom app name is already in use"),
    CUSTOM_APP_PROPERTY_NAME_TAKEN(HttpStatus.BAD_REQUEST, "Property name is already in use in this custom app"),
    CUSTOM_APP_PROPERTY_TYPE_INVALID(HttpStatus.BAD_REQUEST, "Property type is not supported"),
    CUSTOM_APP_PROPERTY_CONFIG_INVALID(HttpStatus.BAD_REQUEST, "Property configuration is invalid for its type"),
    CUSTOM_APP_VIEW_NAME_TAKEN(HttpStatus.BAD_REQUEST, "View name is already in use in this custom app"),
    CUSTOM_APP_VIEW_CONFIG_INVALID(HttpStatus.BAD_REQUEST, "View configuration is invalid"),
    CUSTOM_APP_RECORD_VALUE_INVALID(HttpStatus.BAD_REQUEST, "Record value does not match the property type"),
    CUSTOM_APP_LIMIT_REACHED(HttpStatus.FORBIDDEN, "Plan limit reached; upgrade to add more"),
